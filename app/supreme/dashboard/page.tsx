        ...
        <div className="space-y-2">
          ...
          <label className="flex gap-2 items-center">
            <input type="checkbox"
              ...
              onChange={e => setFiltro({ ...filtro, soloConTelefono: e.target.checked })}
            />
          ...
          <label className="flex gap-2 items-center">
            <input type="checkbox"
              ...
              onChange={e => setFiltro({ ...filtro, soloWhatsapp: e.target.checked })}
            />
        ...
        {filtrati.map(t => (
          ...
          >
            ...
            <div className="text-sm text-right space-y-1">
              <div>Stato: <b>{t.stato_supreme || "—"}</b></div>
              <div>Interesse: <b>{t.interesse_supreme || "—"}</b></div>
              <div>Consenso: <b>{t.stato_consenso || "—"}</b></div>
            </div>
          </div>
        ))}
      </div>
